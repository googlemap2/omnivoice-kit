...
- `frontend/src/app/(studio)/provider-chat/page.tsx`: tab test nhanh Model Provider; chọn provider/model, nhập system prompt/message, gọi `POST /v1/provider-models/chat`.
