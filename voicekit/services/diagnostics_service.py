...
from voicekit.media import check_ffmpeg, ffprobe_path
from voicekit.model_store import DEFAULT_HF_CACHE, DEFAULT_MODEL_BASE_DIR, list_model_statuses


LOG_DIR = Path("data") / "logs"
LOG_FILE = LOG_DIR / "voicekit.log"
_SECRET_PATTERNS = [
...
def setup_logging(log_file: str | Path = LOG_FILE) -> logging.Logger:
    ...
    logger = logging.getLogger("voicekit")
