...
from backend.paths import BACKEND_ROOT, MODELS_DIR
...
DEFAULT_MODEL_BASE_DIR = MODELS_DIR
DEFAULT_HF_HOME = MODELS_DIR / ".hf_home"
...
def configure_hf_local_cache() -> None:
    """Pin Hugging Face / transformers caches under ``backend/models/.hf_home``."""
    ...
    # Keep all hub artifacts inside the backend ``backend/models/`` tree.
