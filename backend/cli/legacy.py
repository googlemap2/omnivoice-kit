...
from backend.paths import OUTPUTS_DIR, SPEAKERS_PATH
...
def main() -> None:
    ...
    speaker_id.add_argument("--speakers", default=str(SPEAKERS_PATH), help="Path to speakers registry json")
    ...
    dub.add_argument("--output-dir", default=str(OUTPUTS_DIR / "dubbing"), help="Output directory")
    ...
    emotion_script.add_argument("--speakers", default=str(SPEAKERS_PATH), help="Path to speakers registry json")
