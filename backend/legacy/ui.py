...
from backend.services.translation_service import TRANSLATION_LANGUAGE_CHOICES, list_providers, translate_for_ui
                    ...
                    with gr.Row():
                        with gr.Column():
                            ...
                            with gr.Accordion("Translation provider API keys", open=True):
                                gr.Markdown(
                                    "Keys are saved locally in `backend/data/settings.json`. "
