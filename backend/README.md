...
```bash
cd omnivoice-voice-clone-kit/backend
uv sync
```
...
```bash
uv run backend-mcp --http --host 0.0.0.0 --port 8765
```
...
- `backend://generation-history/recent`: đọc generation history gần đây nếu
